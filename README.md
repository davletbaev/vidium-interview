...
1. Не ясно как ведет себя пагинация, если элементов много. В макете элементы пагинации всегда фиксированной ширины. Однако, если элементов много, то пагинация не влезает в размер компонента. Я принял решение сделать так, чтобы пагинация подстраивалась под ширину контейнера.
